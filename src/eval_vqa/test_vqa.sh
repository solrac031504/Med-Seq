...
BSZ=64
OUTPUT_PATH="./logs/Chart_QA/qwen2_2B_ChartQA_think.json"
PROMPT_PATH="/local/scratch/ylai76/Code/R1-V/src/eval_vqa/prompts/ChartQA/sampled_train_2000.json"

# 运行 Python 代码并传入参数
python test_qwen2vl_vqa_zero_shot_ChartQA.py --model_path "$MODEL_PATH" --batch_size "$BSZ" --output_path "$OUTPUT_PATH" --prompt_path "$PROMPT_PATH"