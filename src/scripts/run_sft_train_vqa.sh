...
ACCELERATE_LOG_LEVEL=info accelerate launch --config_file /local/scratch/ylai76/Code/R1-V/src/r1-v/configs/zero2.yaml /local/scratch/ylai76/Code/R1-V/src/r1-v/src/open_r1/sft.py --config /local/scratch/ylai76/Code/R1-V/src/r1-v/configs/qwen2vl_sft_config_OBA.yaml 
